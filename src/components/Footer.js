      ...
      <div className="footer-content">
        ...
        <div style={{ 
          ...
          <div>
            ...
            <p style={{ marginBottom: '0.5rem' }}>Giryeong Park</p>
            <p style={{ marginBottom: '0.5rem' }}>giryeong.park2006@gmail.com</p>
        ...
        <div className="social-links">
          <a href="https://www.facebook.com/giryeong.park0316" aria-label="Facebook">
            <svg 
              width="24" 
              height="24" 
              viewBox="0 0 24 24" 
          ...
          <a href="https://www.linkedin.com/in/giryeongpark/" aria-label="LinkedIn">
            <svg 
              width="24" 
              height="24" 
              viewBox="0 0 24 24" 
        ...
        <div style={{ marginTop: '2rem', paddingTop: '2rem', borderTop: '1px solid #555' }}>
          <p>&copy; 2025 Nutrificient. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
